...
useEffect(() => {
  ...
  const typingInterval = setInterval(() => {
    ...
    if (!isDeleting) {
      ...
      if (charIndex < currentFullText.length) {
        ...
        // After fully typed, pause then start deleting
        setTimeout(() => {
          isDeleting = true;
        }, 1000);
      }
      ...
      if (charIndex > 0) {
        ...
        // After deleting, move to next text and start typing
        isDeleting = false;
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Advanced logistics management system with shipment tracking, inventory control, and client portal.",
      technologies: [
        "Next.js",
        "React",
        "Tailwind CSS",
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="max-w-4xl mx-auto mb-8 sm:mb-12">
              <div className="bg-cyan-950 border border-cyan-400/40 rounded-lg shadow-xl px-6 py-8 sm:px-10 sm:py-10 text-cyan-100">
                {/* Header */}
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-cyan-300 leading-tight">
                    Full Stack Web Developer
                  </h2>
                  <p className="text-cyan-200 mt-1 text-base">
                ...
                <div className="mb-10 space-y-6">
                  ...
                  <div className="bg-cyan-900/30 border border-cyan-400/30 rounded-lg px-6 py-4 shadow-md">
                    ...
                    <p className="text-green-200 animate-bounce mt-1 text-base">
                    ...
                    <div className="space-y-2">
                      {item.stats.map((stat, i) => (
                        <div key={i} className="flex items-center space-x-2">
                          ...
                          />
                          <span className="text-cyan-300 text-xs sm:text-sm font-mono">
                            {stat}
                          </span>
                        </div>
                      ))}
  ...
  {skills.map((skill, index) => (
    ...
    >
      <div className="flex justify-between items-center mb-3 sm:mb-4">
        ...
        <span className="text-sm sm:text-base text-right text-cyan-100 font-mono capitalize">
          {skill.level}
        </span>
      </div>
      ...
      <div className="relative h-3 sm:h-4 bg-black/50 rounded-full overflow-hidden border border-cyan-500/20 group-hover:border-cyan-400/50 transition-all duration-500">
        ...
        <div
          ...
          style={{
            ...
            boxShadow: `0 0 15px ${
              skill.color.includes("cyan") ? "#22d3ee" : "#c084fc"
            }40`,
          }}
        >
                      ...
                      {Object.entries(project.metrics).map(
                        ([key, value], i) => (
                          <div key={key} className="text-center">
                            ...
                            <div className="text-cyan-300/60 text-xs uppercase tracking-wider">
                              {key}
                            </div>
                          </div>
                        )
